// Site asistanı — model sağlayıcı soyutlaması.
//
// ⚠️ BU DOSYA `relocation-assistant/providers.ts` İLE AYNIDIR ve kopya olması
// BİLİNÇLİDİR. `relocation-assistant` canlıda çalışıyor; onu `_shared`'a taşımak
// kullanıcıya sıfır değer katarken gerçek regresyon riski taşıyor. İki dosyayı
// birleştirme işi ertelendi: docs/kalanlar/2026-09-21-site-geneli-ai-bot-kalan-isler.md
// (K3). Birini değiştirirken diğerini de gözden geçir.
//
