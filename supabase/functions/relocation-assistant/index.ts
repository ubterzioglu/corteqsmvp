 ...
 * PostgREST bunu Postgres biçiminde döndürür (ör. `2026-09-20T10:00:00+00:00`) ama
 * `Date.toISOString()` `2026-09-20T10:00:00.000Z` üretir. İki metin asla eşleşmezse
 * her istek "yeni pencere" sayılır, sayaç her seferinde 1'e döner ve SINIR TAMAMEN
 * ÖLÜR — üstelik hiçbir hata vermeden. Bu yüzden iki taraf da epoch'a çevrilip
 * sayı olarak karşılaştırılır.
 *
 * Yarış durumu: okuma ile yazma arasında eşzamanlı istek sayacı aşabilir. Tam
 * atomiklik tek SQL ifadesi (ya da RPC) ister; burada pencere başına en fazla birkaç
 * fazladan isteğe izin veren bu yaklaşım bilinçli tercihtir — asıl korunan şey
 * sürekli çağrı akışıdır, tek bir fazladan istek değil.
 */
