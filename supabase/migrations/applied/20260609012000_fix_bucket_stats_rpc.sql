...
-- get_submission_documents_bucket_stats was checking public.admin_users which was
-- dropped in 20260609003000_drop_legacy_tables. Rewrite to use public.is_admin().
