...
-- Copy the currently enabled bireysel baseline to every other active role.
-- This migration is additive/idempotent: it does not delete role-specific extras,
-- but it ensures that any feature/attribute/profile-section enabled for bireysel
-- is also enabled for the rest of the active roles.
