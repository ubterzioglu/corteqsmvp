...
const LegalLayout = ({ title, seoKey, children }: { title: string; seoKey: PageSeoKey; children: ReactNode }) => {
  useSeo(PAGE_SEO[seoKey], [seoKey]);
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-xs text-muted-foreground mb-6">
            Son güncelleme: 23 Haziran 2026 · Yürürlük tarihi: 23 Haziran 2026
          </p>
