...
const blocks: GuideBlock[] = [
  {
    heading: "1. Kimlik Doğrulama (Auth)",
    sections: [
      {
        title: "Nasıl çalışır?",
        items: [
  ...
  {
    heading: "3. Feature Flag Sistemi",
    sections: [
      {
        title: "Feature kategorileri",
        items: [
          ...
          "GenericFeatureKey — Profil: profile.view_own, profile.edit_own, profile.edit_public, profile.linkedin_card, profile.website_card, profile.cv_upload, profile.presentation_upload",
          "GenericFeatureKey — Directory: directory.visible, directory.featured",
          "GenericFeatureKey — İletişim: contact.receive, contact.show_whatsapp",
          "GenericFeatureKey — İçerik: content.create, content.edit_own",
          "GenericFeatureKey — Üretim: events.create, offers.create, referral.create",
          "GenericFeatureKey — Platform: cadde.access, city.manage, whatsapp_landing.edit_assigned",
          "GenericFeatureKey — Sistem: admin.requires_approval",
        ],
      },
      {
  ...
  {
    heading: "6. Profile Section Sistemi",
    sections: [
      {
        title: "Tablo yapısı",
        items: [
  ...
  {
    heading: "8. Admin Panel Haritası",
    sections: [
      {
        title: "Üyeler grubu",
        items: [
          "/admin/new-member/users-roles — Loginli kullanıcılar listesi + rol atama + attribute/taxonomy düzenleme.",
          "/admin/new-member/roles-features — Rol bazlı feature kuralları, global feature durumu.",
          "/admin/new-member/attributes — Attribute kural editörü (is_enabled, is_required, vs.).",
          "/admin/new-member/profile-sections — Section sıralaması ve aktiflik.",
          "/admin/new-member/taxonomy — Taxonomy grup ve option yönetimi.",
          "/admin/new-member/overrides — Kullanıcı bazlı feature override yönetimi.",
          "/admin/new-member/guide — Bu kılavuzun operasyon özeti.",
        ],
      },
      {
        ...
        items: [
          ...
          "/admin/data — Attribute, feature, section katalog görünümü (salt okunur).",
    ...
    <AdminPageLayout className="max-w-5xl gap-10">
      <section className="space-y-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-foreground">
              Auth, Roller, Featurelar ve Attributelar
            </h1>
            <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
              Platformun kimlik doğrulama akışını, rol sistemini (legacy + RolesGo),
              feature flag çözümleme mantığını ve attribute katmanlarını kod seviyesinde
              anlatan kapsamlı teknik kılavuz.
            </p>
          </div>
          <Link
            to="/admin/new-member/guide"
            className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-white/90 px-4 py-2 text-xs font-medium text-slate-700 shadow-sm transition hover:bg-slate-50"
          >
        ...
        <div className="flex flex-wrap gap-2">
          {["Auth", "Roller", "Feature Flags", "Attributes", "Taxonomy", "Sections", "Süreç Akışları", "Admin Haritası"].map((tag) => (
...
export default AdminClaudeGuidePage;
