    ...
    sections: [
      {
        ...
        items: [
          "Cadde sosyal akışının yönetim ekranı: içerik/akış moderasyonu buradan yapılır.",
          "Tanıtım (/admin/cadde/promotions): sponsorlu görünürlük kampanyaları — kampanya oluşturma, süre ve hedefleme yönetimi.",
        ],
      },
      {
