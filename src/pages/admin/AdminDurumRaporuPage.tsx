...
// ── Son güncellemeler ────────────────────────────────────────────────────────
// Tek kaynak: lib/admin-shell/admin-updates.ts — topbar'daki zil menüsü,
// /admin/about ve dashboard kartı da aynı listeden beslenir. Bu sayfa vaktiyle
// listenin elle tutulan bir kopyasını taşıyordu; kopya 31 kayıtta donmuş,
// kanonik liste 100+ kayda çıkmıştı. Kayıt eklemek/düzeltmek için
// admin-updates.ts'i düzenle — burada ayrı bir liste TUTMA.
const RECENT_UPDATE_LIMIT = 30;
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {ADMIN_UPDATES.slice(0, RECENT_UPDATE_LIMIT).map((u) => (
