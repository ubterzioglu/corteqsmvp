...
const DB_TABLES: TableInfo[] = [
  ...
  { name: "catalog_item_managers", description: "Kayıt Yöneticileri", purpose: "Bir katalog kaydını yönetme yetkisi olan kullanıcılar (eski üyelik/membership tablosu).", rowCount: 38, rls: true, group: "Katalog" },
  { name: "catalog_item_roles", description: "Kayıt–Rol Bağlantıları", purpose: "Katalog kaydı ile düz (flat) roller arasındaki M:N bağlantı; kayıt başına tek birincil (primary) rol.", rowCount: 76, rls: true, group: "Katalog" },
  { name: "catalog_item_attribute_values", description: "Kayıt Nitelik Değerleri", purpose: "Kayıtlara eklenen özel nitelik değerleri.", rowCount: 4, rls: true, group: "Katalog" },
  ...
  { name: "catalog_item_claims", description: "Sahiplik Talepleri", purpose: "Kullanıcıların bir katalog kaydının sahibi olduğunu talep etmesi.", rowCount: 1, rls: true, group: "Katalog" },
  ...
  // Rol & Yetki Sistemi
  { name: "roles", description: "Roller", purpose: "Sistemdeki tüm düz (flat) rollerin tanım listesi.", rowCount: 82, rls: true, group: "Rol & Yetki" },
  { name: "afs_features", description: "Özellik Kataloğu", purpose: "Sistemdeki tüm özellik bayraklarının (AFS) tanımları.", rowCount: 42, rls: true, group: "Rol & Yetki" },
  ...
  { name: "afs_attributes", description: "Nitelik Kataloğu", purpose: "Profillere eklenebilecek niteliklerin (AFS) tanım listesi.", rowCount: 33, rls: true, group: "Rol & Yetki" },
  { name: "afs_sections", description: "Profil Bölüm Kataloğu", purpose: "Profil sayfasındaki bölümlerin (AFS) tanım listesi.", rowCount: 7, rls: true, group: "Rol & Yetki" },
  { name: "role_features", description: "Rol–Özellik Bayrakları", purpose: "Her düz role hangi özelliklerin atanacağını belirler.", rowCount: 2487, rls: true, group: "Rol & Yetki" },
  ...
  { name: "role_attributes", description: "Rol Nitelik Kuralları", purpose: "Düz role göre nitelik görünürlük ve zorunluluk kuralları.", rowCount: 1977, rls: true, group: "Rol & Yetki" },
  { name: "role_sections", description: "Rol Profil Bölüm Kuralları", purpose: "Düz role göre profil bölümü görünürlük kuralları.", rowCount: 574, rls: true, group: "Rol & Yetki" },
