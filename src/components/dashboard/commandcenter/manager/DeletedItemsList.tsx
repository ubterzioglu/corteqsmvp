// Komuta Merkezi — silinmiş kayıtlar listesi (salt okunur).
// Silme YUMUŞAKTIR: satır durur, yalnız `deleted_at` damgalanır. Bu liste o
// damgayı taşıyan kayıtları gösterir, geri alma işlemi burada yoktur.
...
export default function DeletedItemsList({ items }: { items: CommandCenterItem[] }) {
  if (items.length === 0) {
    return (
