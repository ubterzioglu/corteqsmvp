                    ...
                    >
                      ...
                      <AccordionContent className="pb-6">
                        <div className="grid items-center gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-8">
                          ...
                          >
                            CorteQS, dünyanın farklı şehirlerinde yaşayan Türkleri birbirine bağlayan bir
                            platformdur. İnsanlar burada toplulukları bulur, yeni bağlantılar kurar ve iş,
                            destek veya işbirliği fırsatlarına ulaşır.
                          </p>
