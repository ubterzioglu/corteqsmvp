...
export const ADMIN_UPDATES_2026_09: AdminUpdateEntry[] = [
  {
    ...
    items: [
      ...
      "⚠️ ÖNCE DÜRÜST OLALIM — '57 MADDE KAPANDI' 57 İŞ YAPILDI DEMEK DEĞİL: Komuta Merkezi'nde son iki günde 68 maddeye dokunuldu, 57'si 'Tamamlandı' işaretlendi. Ama bu üç ayrı şeyin toplamı: **22 madde gerçekten yapıldı ve kanıtıyla doğrulandı**, **21 madde 'artık geçerli değil' denilerek İPTAL EDİLDİ** (yani yapılmadı), **12 madde de benzerleriyle tek maddede BİRLEŞTİRİLDİ** (iptal değil, tek kaynağa indirildi). Aşağıda üçü ayrı ayrı, madde madde yazılı. Hiçbiri silinmedi; hepsi gerekçesiyle kayıtlı ve gerekirse yeniden açılabilir. Kararların tam dökümü `docs/notes/2026-09-13-komuta-merkezi-iptal-edilenler.md` dosyasında.",
