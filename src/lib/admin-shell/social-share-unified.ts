 ...
 * dizilişi. İlk 12 kalem (item-3, item-12, item-21, item-30, item-39, item-48,
 * item-53, item-62, item-71, item-80, item-89, item-98) BURAK_SHARE_TOOLS'un
 * 1..12 sırasındaki 12 kartıdır — 2026-07-21'de docs/social-share-outputs
 * altındaki üretilmiş görsellere sahip TEK kaynak oldukları için önceliklendi
 * (bkz. reseed-social-share-outputs.mjs). Geri kalan 88 kalem, önceki
 * mulberry32(seed=20260721) deterministik shuffle çıktısından bu 12'si
 * çıkarılarak aynı göreli sırada korunmuştur. globalId'lerin kendisi
...
const RANDOMIZED_ORDER: readonly string[] = [
  ...
  "item-71", "item-80", "item-89", "item-98",
  ...
  "item-59", "item-58", "item-83", "item-99", "item-17", "item-11", "item-92", "item-75",
  "item-35", "item-23", "item-24", "item-65", "item-36", "item-74", "item-8", "item-68",
  "item-13", "item-93", "item-88", "item-60", "item-7", "item-78", "item-6", "item-41",
  "item-22", "item-66", "item-19", "item-67", "item-82", "item-84", "item-72", "item-76",
  "item-15", "item-18", "item-61", "item-31", "item-32", "item-5", "item-47", "item-20",
  "item-42", "item-27", "item-63", "item-85", "item-97", "item-46", "item-50", "item-77",
  "item-44", "item-70", "item-86", "item-87", "item-69", "item-40", "item-14", "item-45",
  "item-73", "item-10", "item-100", "item-38", "item-34", "item-96", "item-91", "item-55",
  "item-29", "item-64", "item-56", "item-81", "item-4", "item-33", "item-90", "item-94",
];
