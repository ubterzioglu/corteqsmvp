...
const DEMO_COUNTRIES: CaddeCountry[] = [
  ...
  { id: "country-gb", code: "GB", name: "Birlesik Krallik" },
  { id: "country-us", code: "US", name: "Amerika Birlesik Devletleri" },
  { id: "country-tr", code: "TR", name: "Turkiye" },
];
...
const DEMO_CITIES: CaddeCity[] = [
  ...
  { id: "city-istanbul", countryId: "country-tr", name: "Istanbul", timezone: "Europe/Istanbul" },
];
...
const DEMO_POSTS: CaddePost[] = [
  {
    ...
    mode: "demo",
    type: "question",
    title: "Berlin'de yaz staji icin topluluk arayisi",
    body: "2 haftadir Berlin'deyim. Hem urun tarafinda hem de etkinliklerde dahil olabilecegim samimi bir cevre ariyorum.",
    authorName: "Elif Demir",
    authorRole: "Yeni Tasinan",
    ...
    commentCount: 2,
    comments: [
      { id: "demo-comment-1", postId: "demo-post-1", userId: "demo", body: "Berlin product meetuplarini paylasabilirim.", authorName: "Mert Koca", createdAt: "2026-05-28T12:00:00.000Z" },
      { id: "demo-comment-2", postId: "demo-post-1", userId: "demo", body: "Cumartesi ortak calisma bulusmasina bekleriz.", authorName: "Seda Yalcin", createdAt: "2026-05-28T13:00:00.000Z" },
    ],
    viewerReactions: [],
  },
  {
    ...
    mode: "demo",
    type: "offer",
    title: "Amsterdam ortak calisma bulusmasi",
    body: "Persembe gunu saat 19:00'da merkezde serbest calisma + networking oturumu yapiyoruz. Urun, ihracat ve freelancer herkes gelebilir.",
    ...
    commentCount: 1,
    comments: [{ id: "demo-comment-3", postId: "demo-post-2", userId: "demo", body: "Ilk kez gelenler icin de uygun.", authorName: "Deniz O.", createdAt: "2026-05-27T18:00:00.000Z" }],
    viewerReactions: [],
  },
  {
    id: "demo-post-3",
    mode: "demo",
    type: "event",
    title: "Londra girisimci kahvesi acildi",
    body: "Bu hafta sonu Londra'da yatirim, diaspora networku ve yeni pazar acilisi konularini konusacagiz.",
    authorName: "Seda Yalcin",
    authorRole: "Kurucu",
    authorAvatarUrl: null,
    authorUserId: null,
...
const DEMO_CAFES: CaddeCafe[] = [
  {
    ...
    summary: "Yeni gelenler ve uzun suredir burada olanlar icin hizli tanisma odasi.",
    hostName: "Ayse U.",
    country: "Almanya",
    city: "Berlin",
    isBridge: false,
  ...
  {
    id: "demo-cafe-2",
    title: "TR-Kopru Mentor Cafe",
    summary: "Turkiye ile diaspora arasinda tasinma ve is baglantilari icin ortak oda.",
    hostName: "Can E.",
    country: "Turkiye",
    city: "Istanbul",
    isBridge: true,
...
const DEMO_BILLBOARDS: CaddeBillboardCard[] = [
  {
    id: "demo-board-1",
    type: "consultant",
    title: "Oturum ve Tasinma Danismani",
    subtitle: "Berlin",
    description: "Yeni tasinanlar icin resmi surecler, oturum ve ilk 90 gun kontrol listesi.",
    badgeText: "Danisman",
    ctaLabel: "Gorusme Talep Et",
  ...
  },
  {
    ...
    subtitle: "Amsterdam",
    description: "Hafta ici networking masasi ve topluluk kampanyalariyla isletmenizi one cikarın.",
    badgeText: "Business",
    ctaLabel: "Mekani Kesfet",
  ...
  },
  {
    ...
    description: "Kurucular, icerik ureticileri ve topluluk liderleri icin aksiyon odakli bulusma.",
    badgeText: "Etkinlik",
    ctaLabel: "Etkinlige Git",
    ctaUrl: "/anket",
    imageUrl: null,
    isFeatured: true,
  },
...
const DEMO_SPONSORED: CaddeSponsoredPlacement = {
  id: "demo-sponsored-1",
  title: "Sponsorlu Gorunum",
  description: "Danisman, etkinlik veya topluluk teklifinizi Cadde akisinda gorunur hale getirin.",
  badgeText: "Sponsorlu",
...
const FALLBACK_PROFILE_NAME = "CorteQS Uyesi";
const PAGE_SIZE = 20;
