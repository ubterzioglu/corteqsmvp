import { Home, Plane, Briefcase, Scale, TrendingUp, Heart, Star, Baby, Brain, GraduationCap, Package, Camera, Rocket, Award } from "lucide-react";
...
const categories = [
  ...
  {
    icon: Award,
    title: "Marka & Patent Vekilleri",
    desc: "Fikri mülkiyet ve marka koruma",
    subs: [
      "Marka tescil & takip",
      "Patent başvuru & koruma",
      "Fikri mülkiyet danışmanlığı",
      "Tasarım tescil",
      "Lisanslama & franchising hukuku",
    ],
  },
  {
    icon: TrendingUp,
