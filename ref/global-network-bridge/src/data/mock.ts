...
export interface Consultant {
  ...
  languages: string[];
  specialties: string[];
  countriesLived?: { country: string; from?: number | string; to?: number | string }[];
}
...
export const consultants: Consultant[] = [
  ...
  { id: "dilek-aydin-psk", name: "Psk. Dilek Aydın", role: "Psikolog — Göçmen Psikolojisi", category: "Yaşam & Relocation", country: "Almanya", city: "Berlin", rating: 4.9, reviews: 142, avatar: "DA", photo: "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?w=400&h=400&fit=crop&crop=face", bio: "Berlin'de Türkçe terapi veren klinik psikolog. Göçmen psikolojisi, adaptasyon stresi ve aile danışmanlığı.", website: "https://dilekaydin.de", whatsapp: "+491700000099", languages: ["Türkçe", "Almanca", "İngilizce"], specialties: ["Psikolog", "Göçmen psikolojisi", "Stres & adaptasyon", "Aile terapisi"] },
  { id: "ozlem-gonullu", name: "Özlem Yıldırım", role: "Gönüllü Mentör — Yeni Gelenlere Destek", category: "Yaşam & Relocation", country: "Hollanda", city: "Amsterdam", rating: 4.9, reviews: 87, avatar: "ÖY", photo: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop&crop=face", bio: "Amsterdam'da 12 yıldır yaşıyorum. Yeni gelen Türk ailelerine ücretsiz olarak şehre adaptasyon, bürokrasi ve günlük yaşam konularında dayanışma odaklı mentörlük yapıyorum.", website: "", whatsapp: "+316000000099", languages: ["Türkçe", "Hollandaca", "İngilizce"], specialties: ["Şehre adaptasyon", "Bürokratik işlemler", "Okul & kreş seçimi", "Topluluk bağlantıları"] },
];
...
export const associations: Association[] = [
  ...
  { id: "dubai-is-konseyi", name: "Dubai İş İnsanları Konseyi", type: "İş Örgütü", country: "BAE", city: "Dubai", members: 480, events: 14, description: "BAE'de faaliyet gösteren Türk iş insanlarını bir araya getiren konsey. Networking etkinlikleri, ticari heyetler ve yatırım danışmanlığı.", website: "https://dubaiturkbusinesscouncil.ae", founded: 2011, logo: "DTİK" },
  { id: "londra-turk-yatirimcilar", name: "Londra Türk Yatırımcılar Derneği", type: "Dernek", country: "İngiltere", city: "Londra", members: 320, events: 9, description: "Birleşik Krallık'taki Türk yatırımcıları ve girişimcileri buluşturan dernek. Sermaye piyasaları, gayrimenkul ve fintech alanlarında network ve mentörlük.", website: "https://lturkinvestors.co.uk", founded: 2016, logo: "LTYD" },
