import { MapPin, Users, Briefcase, UserPlus, UserCheck, Video } from "lucide-react";
...
import AIConsultationCTA from "@/components/AIConsultationCTA";
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <Link to={`/business/${b.id}`} className="flex-1" onClick={(e) => e.stopPropagation()}>
                      <Button variant="default" size="sm" className="w-full gap-1"><Video className="h-3.5 w-3.5" /> Canlı Görüşme</Button>
                    </Link>
                    <Link to={`/business/${b.id}`} className="flex-1" onClick={(e) => e.stopPropagation()}>
                  ...
                  <AIConsultationCTA label="AI Görüşme" contextName={b.name} />
                </div>
              </Link>
            );
          })}
