...
Convenience redirects are also available:

- `/business-information` -> `/legal/business-information`
- `/refund-policy` -> `/legal/refund-cancellation`
- `/cancellation-policy` -> `/legal/refund-cancellation`
- `/delivery-policy` -> `/legal/service-delivery`
